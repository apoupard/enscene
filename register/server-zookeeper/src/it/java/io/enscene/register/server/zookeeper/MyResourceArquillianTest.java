...
public class MyResourceArquillianTest {
  ...
  public void should_register_service(
      @ArquillianResteasyResource("services") ResteasyWebTarget webTarget) {
    ServiceId id = ServiceId.from("serviceName", "1.0");
    Service service = Service.from(id, SERVICE1_URL);
    Response response =
        webTarget.request().post(Entity.entity(service, MediaType.APPLICATION_JSON));
  ...
  @RunAsClient
  @InSequence(2)
  public void should_retrieveRegisteredService(
      @ArquillianResteasyResource("services/serviceName/1.0/instance") ResteasyWebTarget webTarget) {
  ...
  @RunAsClient
  @InSequence(3)
  public void should_register_service2(
      @ArquillianResteasyResource("services") ResteasyWebTarget webTarget) {
    ServiceId id = ServiceId.from("serviceName", "1.0");
  ...
  @RunAsClient
  @InSequence(4)
  public void should_retrieveRegisteredServices(
      @ArquillianResteasyResource("services/serviceName/1.0/instances") ResteasyWebTarget webTarget) {
  ...
  @RunAsClient
  @InSequence(5)
  public void unRegisteredService1(
      @ArquillianResteasyResource("services/serviceName/1.0/url") ResteasyWebTarget webTarget) {
  ...
  @RunAsClient
  @InSequence(6)
  public void should_retrieveOnlyOneRegisteredService(
      @ArquillianResteasyResource("services/serviceName/1.0/instances") ResteasyWebTarget webTarget) {
    List<Service> services = webTarget.request().get(new GenericType<List<Service>>() {});
  ...
  @RunAsClient
  @InSequence(7)
  public void unRegisteredService2(
      @ArquillianResteasyResource("services/serviceName/1.0/url2") ResteasyWebTarget webTarget) {
    Response response = webTarget.request().delete();
    assertThat(response.getStatus()).isEqualTo(204);
  ...
  @RunAsClient
  @InSequence(8)
  public void should_retrieveNoRegisteredService(
      @ArquillianResteasyResource("services/serviceName/1.0/instances") ResteasyWebTarget webTarget) {
    List<Service> services = webTarget.request().get(new GenericType<List<Service>>() {});
